package com.team114.starbucks.common.response;
...
public enum BaseResponseStatus {
     ...
     */
    // common : 1000
    FAILED_TO_SAVE(HttpStatus.BAD_REQUEST, false, 1001, "저장에 실패하였습니다."),
    FAILED_TO_FIND(HttpStatus.NOT_FOUND, false, 1002, "조회에 실패하였습니다."),

    // security : 1100
    WRONG_JWT_TOKEN(HttpStatus.UNAUTHORIZED, false, 1101, "다시 로그인 해주세요"),
    NO_SIGN_IN(HttpStatus.UNAUTHORIZED, false, 1102, "로그인을 먼저 진행해주세요"),
    NO_ACCESS_AUTHORITY(HttpStatus.FORBIDDEN, false, 1103, "접근 권한이 없습니다"),
    DISABLED_USER(HttpStatus.FORBIDDEN, false, 1104, "비활성화된 계정입니다. 계정을 복구하시겠습니까?"),
    FAILED_TO_RESTORE(HttpStatus.INTERNAL_SERVER_ERROR, false, 1105, "계정 복구에 실패했습니다. 관리자에게 문의해주세요."),
    NO_EXIST_OAUTH(HttpStatus.NOT_FOUND, false, 1106, "소셜 로그인 정보가 존재하지 않습니다."),
    NO_EXIST_VALUE(HttpStatus.NOT_FOUND, false, 1107, "해당 정보가 존재하지 않습니다."),
